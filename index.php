...
ob_start();
$API_KEY = '5740915011:AAHM0JWx1N3laLsjkDUmOsJqrrkKkyNva7Q'; //add your bot token
$sudo = 5363098311; // add your id
$bot_id = 5363098311; 
$e = "@S8BBBOT";
...
bot('sendMessage',[
    'chat_id'=>$chat_id,
    'text'=>"💯¦ مـرحبآ آنآ بوت آسـمـي هلكرد 🎖
💰¦ آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
📛¦ مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...
👨🏽‍🔧",
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        [['text'=>"آلمـطـور 🌿",'url'=>"https://t.me/LLLLVO"]]
    ]
...
bot('sendContact',[
'chat_id'=>$chat_id,
'phone_number'=>"+9647748855980",
'first_name'=>"كۣۗـۙلَفۣۗـۙ",
...
bot('sendMessage',[
'chat_id'=>$chat_id, 
'text'=>"يَمـه‌ إآلُحــ❤ــب يَمـه‌ ❤️😍",
'reply_to_message_id'=>$message->message_id, 
]);
}
if($text == "😉"){
...
if($text == 'هلكرد'){
$rand = array('سويت هواي شغلات سخيفه بحياتي بس عمري مصحت على واحد وكلتله انجب 😑','نعم حبي 😎','اشتعلو اهل هلكرد شتريد 😠','لك فداك هلكرد حبيبي انت اموووح 💋','بووووووووو 👻 ها ها فزيت شفتك شفتك لا تحلف 😂','هياتني اجيت 🌚❤️','راجع المكتب حبيبي عبالك هلكرد سهل تحجي ويا 😒','باقي ويتمدد 😎','لك دبدل ملابسي اطلع برااااا 😵😡 ناس متستحي','دا اشرب جاي تعال غير وكت 😌','هوه غير يسكت عاد ها شتريد 😷','انت مو اجيت البارحه تغلط عليه ✋🏿😒');
...
ob_start();
$API_KEY = '5740915011:AAE-mkF3aNPxYj1sBnYRqKFKba_tevcyElM'; //add your bot token
$sudo = 5363098311; // add your id
$bot_id = 5363098311; 
$e = "@S8BBBOT";
define('API_KEY',$API_KEY);
